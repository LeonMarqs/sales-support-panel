...
@Service
public class CancelCampaignUseCase extends UseCase<CancelCampaignUseCase.Input, CancelCampaignUseCase.Output> {

    private final CampaignRepository campaignRepository;

    public CancelCampaignUseCase(final CampaignRepository campaignRepository) {
