...
@Service
public class CompleteCampaignUseCase extends UseCase<CompleteCampaignUseCase.Input, CompleteCampaignUseCase.Output> {

    private final CampaignRepository campaignRepository;

    public CompleteCampaignUseCase(final CampaignRepository campaignRepository) {
